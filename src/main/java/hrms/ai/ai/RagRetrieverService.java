...
public class RagRetrieverService {
    ...
    public void init()
    {
        policyStore.put("CL", "12 days of casual leave per year. Cannot be combined with other leave types.");
        policyStore.put("SL", "Employees get 8 days of sick leave. Medical certificate required for more than 2 consecutive days.");
        policyStore.put("PL", "Employees are entitled to 15 days of privilege leave per year. Unused leave can be carried forward up to 5 days.");
